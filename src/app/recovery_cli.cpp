...
void printHelp() {
    std::cout
        ...
        << "  -d_type 1|2|3        Derivation engine policy.\n"
        << "                       1=bip32-secp256k1, 2=slip0010-ed25519, 3=check both.\n"
        << "                       If omitted, the default routing stays target-native.\n"
        << "  -hash HEX            Exact hash prefix target.\n"
        << "  -bf FILE             Bloom filter target.\n"
        << "  -xu FILE             XOR filter (.xor_u).\n"
        << "  -xc FILE             XOR filter (.xor_c).\n"
        << "  -xuc FILE            XOR filter (.xor_uc).\n"
        << "  -xh FILE             XOR filter (.xor_hc).\n"
        << "  -xx FILE             CPU verify XOR filter.\n"
